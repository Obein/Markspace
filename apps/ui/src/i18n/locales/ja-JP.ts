...
export const jaJP: typeof enUS = {
  ...
  unlockWithPasskey: 'Passkeyでロック解除 (Touch ID / Windows Hello)',
  ...
  passkeyAutoBindNotice: '保管庫は現在のデバイス（Touch ID / Windows Hello / Face ID）に自動バインドされ、8語の復元フレーズが付属します。',
  ...
  recoveryKeyNotice: '保管庫作成時に生成された8つの英単語を入力してください。',
  ...
  passkeyAccountDesc: 'アカウントにバインドし、Touch IDやWindows Helloで瞬時に保管庫を安全に復号します。',
