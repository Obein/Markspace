...
export const koKR: typeof enUS = {
  ...
  deleteLastPasskeyWarning: '등록된 유일한 Passkey입니다. 제거 후에는 생체 인증으로 잠금을 해제할 수 없으며, 8단어 복구 구문으로만 복구/잠금 해제가 가능합니다.',
  deletePasskeyWarning: '계정에서 이 Passkey를 제거하시겠습니까?',
  orphanPasskeyNotice: '알림: 제거 후 이 기기의 자격 증명 관리자에 남아 있는 Passkey는 고아 Passkey가 되므로 직접 삭제해야 합니다.',
  confirmRemove: '제거 확인',
  ...
  rememberMe7Days: '7일 동안 로그인 상태 유지',
  valid7Days: '7일 세션',
  valid1Day: '1일 세션',
  default1Day: '기본 1일',
  activeSessions: '활성 세션 및 온라인 기기',
  activeSessionsDesc: '로그인된 기기와 세션 자격 증명을 관리합니다',
  currentDevice: '현재 기기',
  lastActive: '최근 활동',
  terminate: '연결 끊기',
  terminateSession: '세션 종료',
  revokeOtherSessions: '다른 모든 세션 종료',
  confirmRevokeOthers: '다른 모든 기기 연결 종료 확인',
  foundOtherSessions: '다른 활성 세션이 감지되었습니다',
  sessionTerminated: '세션이 종료되었습니다',
  otherSessionsTerminated: '다른 모든 세션이 종료되었습니다',
  loadingSessions: '세션 목록 로드 중...',
  noActiveSessions: '활성 세션이 없습니다',
  timeoutAction: '타임아웃 동작',
  sessionAutoLoggedOut: '장시간 미사용으로 자동 로그아웃되었습니다',
  refresh: '새로고침',
  customHex: '사용자 지정 HEX 색상',
  zeroTrustActive: '제로 트러스트 보안 세션',
  logout: '로그아웃',

  // Third-Party Storage
  thirdPartyStorage: '타사 스토리지 솔루션',
  thirdPartyStorageAvailable: '타사 스토리지 선택 가능',
  thirdPartyStorageAvailableHint: '✨ 타사 스토리지 사용 가능 (S3 / 클라우드 드라이브 / WebDAV)',
  firstPartyR2Storage: 'Cloudflare R2 (퍼스트 파티 스토리지)',
  firstPartyR2Badge: '퍼스트 파티 R2',
  s3CompatibleStorage: 'S3 호환 스토리지',
  s3EnabledBadge: 'S3 활성',
  s3ActiveHint: '이 볼트는 S3 호환 객체 스토리지를 사용합니다',
  commercialCloudDrive: '상용 클라우드 드라이브',
  cloudDriveEnabledBadge: '드라이브 활성',
  cloudDriveActiveHint: '이 볼트는 상용 클라우드 드라이브를 사용합니다',
  webdavStorage: 'WebDAV 프로토콜',
  webdavEnabledBadge: 'WebDAV 활성',
  webdavActiveHint: '이 볼트는 WebDAV 서버와 동기화됩니다',
  configured: '설정됨',
  collapse: '접기',
  configure: '설정',
  ...
  testing: '테스트 중...',
  restoreR2: 'R2 복원',
  restoreR2Desc: '기본 Cloudflare R2 스토리지로 복원',
  saveAndBind: '저장 및 적용',
  restoredToR2Toast: 'Cloudflare R2 (퍼스트 파티 스토리지)로 복원되었습니다',
  storageSavedAndEnabled: '스토리지 설정이 저장되고 활성화되었습니다',
  s3ProviderPreset: 'S3 제공업체 프리셋',
  pathPrefixOptional: '경로 접두사 (선택 사항)',
  forcePathStyleDesc: '경로 스타일 강제 Force Path Style (MinIO / S3 호환)',
  targetFolderPath: '저장 대상 폴더 경로',
  accessTokenAuth: 'Access Token / 인증 토큰 *',
  customApiProxyOptional: '사용자 정의 API 프록시 / Endpoint (선택 사항)',
  cloudDriveE2eeNotice: '모든 데이터 청크는 클라이언트 측 AES-256-GCM으로 암호화됩니다.',
  webdavPreset: 'WebDAV 프리셋',
  basePath: '기본 저장 하위 경로',
  usernameOrEmail: '사용자 이름 / 이메일',
  appPassword: '앱 비밀번호 / 키',
  r2CustomPreset: 'Cloudflare R2 (사용자 정의)',
  minioPreset: 'MinIO (자체 호스팅 / 로컬)',
  aliyunOssPreset: 'Aliyun OSS',
  tencentCosPreset: 'Tencent COS',
  customS3Preset: '사용자 정의 S3 Endpoint',
  jianguoyunPreset: 'Nutstore (坚果云 WebDAV)',
  synologyPreset: 'Synology NAS',
  alistPreset: 'AList WebDAV 서비스',
