...
export const koKR: typeof enUS = {
  ...
  unlockWithPasskey: 'Passkey로 잠금 해제 (Touch ID / Windows Hello)',
  ...
  passkeyAutoBindNotice: '금고는 현재 기기(Touch ID / Windows Hello / Face ID)에 자동 바인딩되며 8단어 복구 문구가 함께 제공됩니다.',
  ...
  recoveryKeyNotice: '금고 생성 시 생성된 8개의 공백으로 구분된 단어를 입력하세요.',
  ...
  passkeyAccountDesc: '계정에 바인딩하여 Touch ID 또는 Windows Hello로 모든 암호화 금고를 안전하게 잠금 해제합니다.',
