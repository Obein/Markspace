export const enUS = {
  ...
  unlockWithPasskey: 'Unlock with Passkey (Touch ID / Hello)',
  ...
  recoveryKeyNotice: 'Words separated by spaces generated during vault creation.',
  ...
  passkeyAccountDesc: 'Bound to your account to securely unlock all your E2EE Vaults via Touch ID, Windows Hello, Face ID, or YubiKey.',
