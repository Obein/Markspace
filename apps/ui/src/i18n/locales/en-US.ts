export const enUS = {
  ...
  firstPartyR2Storage: 'Cloudflare R2 (First-Party Storage)',
  firstPartyR2Badge: 'First-Party R2',
  s3CompatibleStorage: 'S3-Compatible Storage',
  s3EnabledBadge: 'S3 Enabled',
  s3ActiveHint: 'This vault uses S3-compatible object storage',
  commercialCloudDrive: 'Commercial Cloud Drive',
  cloudDriveEnabledBadge: 'Cloud Drive',
  cloudDriveActiveHint: 'This vault uses commercial cloud drive storage',
  webdavStorage: 'WebDAV Protocol',
  webdavEnabledBadge: 'WebDAV Enabled',
