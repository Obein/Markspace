...
export const deDE: typeof enUS = {
  ...
  unlockWithPasskey: 'Mit Passkey entsperren (Touch ID / Windows Hello)',
  ...
  recoveryKeyNotice: 'Geben Sie die 8 bei der Erstellung generierten Wörter durch Leerzeichen getrennt ein.',
  ...
  passkeyAccountDesc: 'An Ihr Konto gebunden, um alle Ihre Tresore per Touch ID, Windows Hello oder YubiKey sicher zu entsperren.',
