...
export const zhTW: typeof enUS = {
  ...
  unlockWithPasskey: '使用 Passkey 解鎖 (Touch ID / Windows Hello)',
  ...
  passkeyAutoBindNotice: '您的資料庫將自動綁定目前裝置的硬體認證器 (Touch ID / Windows Hello / Face ID)，並附帶 8 詞助記詞離線備份。',
  ...
  recoveryKeyNotice: '輸入建立資料庫時產生的 8 個空格分隔助記詞。',
  ...
  passkeyAccountDesc: '綁定至您的帳戶，用於在目前裝置上一鍵免密安全解密所有加密資料庫 (Touch ID / Windows Hello / YubiKey)。',
