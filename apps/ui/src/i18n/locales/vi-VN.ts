...
export const viVN: typeof enUS = {
  ...
  unlockWithPasskey: 'Mở khóa bằng Passkey (Touch ID / Windows Hello)',
  ...
  recoveryKeyNotice: 'Nhập 8 từ cách nhau bởi dấu cách được tạo khi thiết lập kho.',
  ...
  passkeyAccountDesc: 'Liên kết với tài khoản của bạn để mở khóa an toàn mọi kho E2EE qua Touch ID hoặc Windows Hello.',
