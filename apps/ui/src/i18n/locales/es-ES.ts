...
export const esES: typeof enUS = {
  ...
  unlockWithPasskey: 'Desbloquear con Passkey (Touch ID / Windows Hello)',
  ...
  recoveryKeyNotice: 'Ingrese las 8 palabras separadas por espacios generadas al crear la bóveda.',
  ...
  passkeyAccountDesc: 'Vinculado a su cuenta para desbloquear de forma segura todas sus bóvedas mediante Touch ID o Windows Hello.',
