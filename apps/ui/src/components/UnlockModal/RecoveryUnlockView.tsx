      ...
      <div className="flex items-center gap-2.5 pb-3 border-b border-black/10 dark:border-white/10">
        ...
        <div>
          <h3 className="text-base font-bold text-zinc-900 dark:text-white flex items-center gap-1.5">
            <KeyRound className="w-4 h-4 text-primaryColor-600 dark:text-primaryColor-400" />
      ...
      <form onSubmit={handleRecoveryUnlock} className="space-y-4">
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3.5 py-2.5 rounded-xl bg-black/5 dark:bg-black/40 border border-black/10 dark:border-white/10 text-xs font-mono text-zinc-900 dark:text-white placeholder-zinc-400 dark:placeholder-zinc-500 focus:outline-none focus:border-primaryColor-500 resize-none"
            autoFocus
          />
