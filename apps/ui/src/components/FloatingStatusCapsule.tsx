...
export const FloatingStatusCapsule: React.FC<FloatingStatusCapsuleProps> = ({
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 max-w-[calc(100vw-2rem)] overflow-x-auto scrollbar-none px-5 py-2.5 glass-capsule rounded-capsule flex items-center gap-3 sm:gap-4 text-xs text-zinc-200 hover:scale-[1.02] active:scale-[0.99] cursor-default select-none pointer-events-auto whitespace-nowrap">
