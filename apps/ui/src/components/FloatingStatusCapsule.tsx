          ...
          {onDeleteCurrentFile && (
            <>
              <button
                ...
                className="p-1.5 rounded-lg bg-white/5 hover:bg-white/10 text-zinc-400 hover:text-blue-300 border border-white/10 transition flex items-center gap-1.5 shrink-0"
                title="Delete Current File"
              >
                <Trash2 className="w-3.5 h-3.5 text-zinc-400 hover:text-blue-400 shrink-0" />
