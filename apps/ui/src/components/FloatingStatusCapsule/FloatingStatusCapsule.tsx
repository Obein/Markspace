  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 max-w-[calc(100vw-2rem)] overflow-x-auto scrollbar-none px-5 py-2.5 glass-capsule rounded-capsule flex items-center gap-3 sm:gap-4 text-xs text-zinc-200 transition-all hover:scale-[1.01] select-none pointer-events-auto whitespace-nowrap">
      ...
      {!isVaultUnlocked && (
        <>
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-blue-300 hover:text-blue-200 font-medium transition shrink-0 cursor-pointer"
      ...
      <button
        ...
        className="p-1.5 rounded-lg hover:bg-white/10 text-zinc-300 transition shrink-0 cursor-pointer"
        title="Toggle Dark/Light Mode"
      >
        {isDark ? (
          <Sun className="w-3.5 h-3.5 text-blue-300 shrink-0" />
        ) : (
