...
export const UserBadge: React.FC<UserBadgeProps> = ({ username, role, onOpenProfile }) => {
  return (
    <button
      ...
      className="flex items-center gap-1.5 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition group focus:outline-none shrink-0 cursor-pointer"
